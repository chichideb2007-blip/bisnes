...
def submit_order():
    ...
    for item in cart_data:
        # البحث عن المعرف بكل الاحتمالات الممكنة
        ...
        try:
            prod_info = None
            # إذا كان لدينا معرف المنتج، نبحث عنه بالـ id
            if p_id:
            ...
            if prod_info:
                ...
                # إذا نفد المنتج تماماً، أرسل تنبيه تيليجرام
                if new_qty <= 0:
