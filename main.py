...
def submit_order():
    ...
    # نقص الكمية (استخدام RPC المخصص في Supabase)
    ...
    if settings_res.data:
        token = settings_res.data[0].get('telegram_token')
        chat_id = settings_res.data[0].get('telegram_chat_id')
